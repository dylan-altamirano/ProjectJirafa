                ...
                <div class="row">
                    ...
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-heading">
                            <h:outputText value="Operacion fallida"/>
                        </div>
                        <!--Text-->
                        <div class="panel-body">
                            <h:outputText value="Algo ha salido mal. Aseguerese de no ingresar informacion invalida. Vuelva a intentarlo."/>
                        </div>
                        <div class="panel-footer panel-custom">
                            <h:outputLink value="principal.jsp">
                                <h:outputText value="Volver a la página de principal del sistema."/>
                            </h:outputLink>
                        </div>
                    </div>
                </div>
